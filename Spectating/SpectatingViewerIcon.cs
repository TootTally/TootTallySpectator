...
namespace TootTallySpectator
{
    public class SpectatingViewerIcon
    {
        ...
        private TootTallyAnimation _currentRotAnimation, _currentScaleAnimation;
        ...
        public void Show()
        {
            ...
            _isActive = true;
            _currentRotAnimation = TootTallyAnimationManager.AddNewEulerAngleAnimation(_imageHolder, new Vector3(0, 0, 0), 1.5f, GetSecondDegreeAnimation());
            _currentScaleAnimation = TootTallyAnimationManager.AddNewScaleAnimation(_imageHolder, Vector3.one, 1.5f, GetSecondDegreeAnimation(), sender => OnFinishAnimating());
        }
        ...
        public void Hide()
        {
            ...
            _isActive = false;
            _currentRotAnimation = TootTallyAnimationManager.AddNewEulerAngleAnimation(_imageHolder, new Vector3(0, 0, -260), 1.5f, GetSecondDegreeAnimation());
            _currentScaleAnimation = TootTallyAnimationManager.AddNewScaleAnimation(_imageHolder, Vector2.zero, 1.5f, GetSecondDegreeAnimation(), sender => { OnFinishAnimating(); _imageHolder.SetActive(false); });
        ...
        public SecondDegreeDynamicsAnimation GetSecondDegreeAnimation() => new(2.2f, .65f, 1f);
    }
}
